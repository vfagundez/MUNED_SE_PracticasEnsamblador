;Rutina de tratamiento de interrupcion par aque gestione un retardo de N
;centesimas  de segundo sin bloquear la ejecución del programa
;Debe avisar al programa principal a traves de una bandera FlagNcs, que sera 
;puesta a cero por el programa principal cuando el retardo de 1 segundo se 
;haya cumplido.
...
Contador        equ     0x0E                        ;Contador
inicio          
                movlw   b'10100000'
                movwf   INTCON                      ;Activamos la interrupcion de timeoverflow
                movlw   .2                          ;Las N centesimas de retardo(ej. 2)
